...
import ru.maconconsulting.librarybackend.utils.exceptions.content.PublicationNotFoundException;
import ru.maconconsulting.librarybackend.utils.search.SearchPublication;
import ru.maconconsulting.librarybackend.utils.validators.content.PublicationValidator;
...
public class PublicationsController {
    ...
    public static final String YANDEX_DISK_LINK = "https://disk.yandex.ru/client/disk/MRG/MACON%20LIBRARY/";
    ...
    public String show(@PathVariable("id") Integer id, Model model) {
        ...
        model.addAttribute("link", YANDEX_DISK_LINK);
